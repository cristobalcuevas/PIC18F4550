...
# 12 "./interrupcion_libreria.h" 2


void INT_Init(void);

void __attribute__((picinterrupt(("high_priority")))) INT0_ALTA(void);
void __attribute__((picinterrupt(("low_priority")))) INT0_BAJA(void);
# 8 "interrupcion_libreria.c" 2
...
void __attribute__((picinterrupt(("low_priority")))) INT1_TMR0(void){
    TMR0L = 60;

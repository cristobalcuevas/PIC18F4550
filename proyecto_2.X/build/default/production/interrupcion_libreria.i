...
# 4 "D:\\Archivos de programa\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdint.h" 2 3
...
# 10 "D:\\Archivos de programa\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdlib.h" 3
...
void __attribute__((picinterrupt(("")))) INT0_ISRs(void){
    x++;
    INTCONbits.INT0IF = 0;
}
